import { getChildrenText } from '@/lib/getChildrenText';
import clsx from 'clsx';
import { children, createMemo, splitProps, type ComponentProps, type JSX } from 'solid-js';

export interface TableCodeProps extends ComponentProps<'code'> {
  printWidth?: number;
}
...
export function TableCode(props: TableCodeProps) {
  ...
  return (
    <code data-table-code="" class={clsx('Code text-xs', local.class)} {...rest}>
      {resolvedChildren()}
    </code>
  );
}
