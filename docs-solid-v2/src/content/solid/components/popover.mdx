...
<Demo path="popover/open-on-hover" compact />
...
<Demo path="popover/detached-triggers-simple" />
...
<Demo path="popover/detached-triggers-controlled" />
...
<Demo path="popover/detached-triggers-full" />
