...
<Demo path="preview-card/detached-triggers-simple" />
...
<Demo path="preview-card/detached-triggers-controlled" />
...
<Demo path="preview-card/detached-triggers-full" />
