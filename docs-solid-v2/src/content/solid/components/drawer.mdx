...
<p>
  <span class="inline-flex rounded-full bg-red-50 px-2 py-0.5 text-[0.6875rem] font-medium uppercase tracking-[0.035em] text-red-700">
    Preview
  </span>
</p>
<Meta
...
<Demo path="drawer/nested" compact />
...
<Demo path="drawer/uncontained" compact />
