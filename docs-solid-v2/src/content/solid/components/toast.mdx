...
<Demo path="toast/anchored" compact />
...
<Demo path="toast/position" compact />
...
Each of the states also accepts the [method options](/solid/components/toast#method-options) object for more granular control.

<Demo path="toast/promise" compact />
...
<Demo path="toast/custom" compact />
...
<Demo path="toast/varying-heights" compact />
...
Each state also accepts the [method options](/solid/components/toast#method-options) object to granularly control the toast for each state:
