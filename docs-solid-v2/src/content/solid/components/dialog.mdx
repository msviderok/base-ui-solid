...
<Demo path="dialog/nested" compact />
...
<Demo path="dialog/close-confirmation" compact />
...
<Demo path="dialog/outside-scroll" compact />
...
<Demo path="dialog/inside-scroll" compact />
...
<Demo path="dialog/uncontained" compact />
...
<Demo path="dialog/detached-triggers-simple" />
...
<Demo path="dialog/detached-triggers-controlled" />
