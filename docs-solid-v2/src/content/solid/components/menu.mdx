...
<Demo path="menu/group-labels" compact />
...
<Demo path="menu/submenu" compact />
...
<Demo path="menu/detached-triggers-simple" />
...
<Demo path="menu/detached-triggers-controlled" compact />
