...
const StyledMenuTrigger = (props: Menu.Trigger.Props) => {
  css`// Button styles`;
  return <Menu.Trigger {...props} />
}

const StyledMenuPositioner = (props: Menu.Positioner.Props) => {
  css`// Positioner styles`;
  return <Menu.Positioner {...props} />
}

const StyledMenuPopup = (props: Menu.Popup.Props) => {
  css`// Popup styles`;
  return <Menu.Popup {...props} />
}

const StyledMenuItem = (props: Menu.Item.Props) => {
