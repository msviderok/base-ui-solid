---
title: 'mergeProps'
description: 'A utility to merge multiple sets of React props, handling event handlers, class, and style props intelligently.'
order: 3
---
...
<Meta
  name="description"
  content="A utility to merge multiple sets of React props, handling event handlers, class, and style props intelligently."
/>
...
<Demo path="utils/merge-props/prevent-base-ui-handler" />
