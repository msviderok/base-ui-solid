              ...
              <ScrollArea.Content class="flex min-h-full items-center justify-center">
                ...
                >
                  <div class="mb-4 flex items-start justify-between gap-3">
                    ...
                    <Dialog.Close
                      aria-label="Close"
                      class="relative top-[-0.5rem] right-[-0.5rem] flex items-center justify-center rounded-md border border-gray-200 bg-gray-50 w-[2.25rem] h-[2.25rem] text-base font-medium text-gray-900 select-none hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-blue-800 active:bg-gray-100"
                    >
                      <XIcon class="h-[1.1rem] w-[1.1rem]" />
                    </Dialog.Close>
                  </div>

                  <Dialog.Description class="m-0 mb-6 text-base leading-[1.6rem] text-gray-600">
                    This layout keeps an outer container scrollable while the dialog can extend past
                    the bottom edge.
                  </Dialog.Description>

                  <div class="mb-[1.75rem] flex flex-col gap-6">
                    {CONTENT_SECTIONS.map((item) => (
                      <section key={item.title}>
                        <h3 class="m-0 mb-[0.4rem] text-base font-semibold leading-6">
                          {item.title}
                        </h3>
                        <p class="m-0 text-[0.95rem] leading-[1.55rem] text-gray-700">
                          {item.body}
                        </p>
                      </section>
                    ))}
