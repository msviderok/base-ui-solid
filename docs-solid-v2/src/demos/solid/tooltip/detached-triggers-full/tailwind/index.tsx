    ...
    <Tooltip.Provider>
      <div class="flex">
        <Tooltip.Trigger
          ...
          payload={InfoContent}
        >
          <InfoIcon aria-label="This is information about the feature" class="size-5" />
        </Tooltip.Trigger>
        ...
        <Tooltip.Trigger
          ...
          payload={HelpContent}
        >
          <HelpIcon aria-label="Need help?" class="size-5" />
        </Tooltip.Trigger>
        ...
        >
          <AlertIcon aria-label="Warning: This action cannot be undone" class="size-5" />
        </Tooltip.Trigger>
      </div>
