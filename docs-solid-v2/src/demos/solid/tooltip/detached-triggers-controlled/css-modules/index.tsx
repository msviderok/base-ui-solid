    ...
    <Tooltip.Provider>
      <div class={styles.Container}>
        <div class={styles.ButtonGroup}>
          <Tooltip.Trigger class={styles.IconButton} handle={demoTooltip} id="trigger-1">
            <InfoIcon aria-label="Controlled tooltip" class={styles.Icon} />
          </Tooltip.Trigger>

          <Tooltip.Trigger class={styles.IconButton} handle={demoTooltip} id="trigger-2">
            <InfoIcon aria-label="Controlled tooltip" class={styles.Icon} />
          </Tooltip.Trigger>

          <Tooltip.Trigger class={styles.IconButton} handle={demoTooltip} id="trigger-3">
            <InfoIcon aria-label="Controlled tooltip" class={styles.Icon} />
          </Tooltip.Trigger>
        </div>
