...
/**
 * @param {unknown} def
 * @returns {def is import('@/components/solid/ReferenceTable/types').ComponentDef}
 */
...
/**
 * @param {unknown} def
 * @returns {def is import('@/components/solid/ReferenceTable/types').FunctionDef}
 */
...
/**
 * @param {import('@/components/solid/ReferenceTable/types').FunctionDef['returnValue'] | undefined} returnValue
 */
 ...
 * @returns {returnValue is Record<string, import('@/components/solid/ReferenceTable/types').PropDef>}
 */
