...
export function AutocompleteRoot<ItemValue>(props: AutocompleteRoot.Props<ItemValue>): JSX.Element {
...
> {
   ...
   */
  value?: AriaCombobox.Props<ComponentProps<'input'>['value'], 'none'>['inputValue'] | undefined;
  /**
